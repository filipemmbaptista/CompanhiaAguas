...
{
    public partial class FirstMigrationEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Locality_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Locality_Meters_MeterId",
                        column: x => x.MeterId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locality_ContractId",
                table: "Locality",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_Locality_MeterId",
                table: "Locality",
                column: "MeterId");
        }
